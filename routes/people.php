...
Route::controller(\App\Http\Controllers\People\IdController::class)
     ...
     ->group(function()
     {
	     Route::get('/mine', 'show')
	          ->name('show');
	     Route::get('/global', 'manageGlobal')
	          ->name('manage.global');
	     Route::post('/global', 'updateGlobal')
	          ->name('manage.global.update');
	     Route::get('/role/{role}', 'manageRole')
	          ->name('manage.role');
	     Route::post('/role/{role}', 'updateRole')
	          ->name('manage.role.update');
	     Route::get('/campus/{campus}', 'manageCampus')
	          ->name('manage.campus');
	     Route::post('/campus/{campus}', 'updateCampus')
	          ->name('manage.campus.update');
	     Route::get('/both/{role}/{campus}', 'manageRoleCampus')
	          ->name('manage.both');
