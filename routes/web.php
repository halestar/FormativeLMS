...
Route::get('/impersonate/{person}', [LoginController::class, 'impersonate'])->name('impersonate');
Route::get('/unimpersonate', [LoginController::class, 'unimpersonate'])->name('unimpersonate');
...
Route::get('/ai/prompt/{aiPrompt}', \App\Livewire\Ai\EditModelPrompt::class)->name('ai.prompt.editor');
