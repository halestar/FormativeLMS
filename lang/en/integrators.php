...
return
    [
        ...
        'integrations.available.no' => 'No integrations are available.',
        'local' => 'Local Integrator',
        'local.ai' => 'Local AI Service',
        'local.ai.connect' => 'Connect to Server',
        'local.ai.connect.error' => 'Error connecting to server',
        'local.ai.connect.success' => 'Ollama is now connected',
        'local.ai.description' => 'A local AI service for testing and development purposes.',
        'local.ai.endpoint' => 'Ollama endpoint',
        'local.ai.endpoint.help' => 'Endpoint for the local ollama connection. Should be something like http://localhost:11434',
        'local.ai.server' => 'AI Server Connection',
        'local.ai.verified' => 'connected',
        'local.ai.verified.no' => 'not connected',
