                            ...
                            <ul class="list-group">
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="text" name="first" id="first" value="{{ $person->first }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="text" name="middle" id="middle" value="{{ $person->middle }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input
                                                ...
                                                id="last"
                                                value="{{ $person->last }}"
                                                class="form-control form-control-sm @error('last') is-invalid @enderror" />
                                ...
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="text" name="nick" id="nick" value="{{ $person->nick }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="email" name="email" id="email" value="{{ $person->email }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="date" name="dob" id="dob" value="{{ $person->dob->format('Y-m-d') }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <select name="ethnicity_id" id="ethnicity_id" class="form-select">
                                ...
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <select name="honors_id" id="honors_id" class="form-select">
                                ...
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <select name="pronoun_id" id="pronoun_id" class="form-select">
                                ...
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="text" name="occupation" id="occupation" value="{{ $person->occupation }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="text" name="job_title" id="job_title" value="{{ $person->job_title }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="text" name="work_company" id="work_company" value="{{ $person->work_company }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="text" name="salutation" id="salutation" value="{{ $person->salutation }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                                <li class="list-group list-group-flush border-bottom mb-2 pb-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="w-50">
                                            <input type="text" name="family_salutation" id="family_salutation" value="{{ $person->family_salutation }}" class="form-control form-control-sm" />
                                        </span>
                                    </div>
                                </li>
                            </ul>
