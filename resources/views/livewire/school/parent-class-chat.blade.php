        ...
        <div class="row h-100">
            <div class="col-md-6 col-lg-5 col-xl-4 mb-4 mb-md-0 p-3 h-100 d-flex flex-column">
                <div class="input-group mb-3">
                    <label for="session-select" class="input-group-text">{{ trans_choice('common.child',$children->count()) }}</label>
                    <select id="student-select" wire:model="selectedStudentId" class="form-select" wire:change="setStudent()">
