<div class="accordion" id="id-elements-container">
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button class="accordion-button @if($selectedElement) collapsed @endif" type="button" data-bs-toggle="collapse" data-bs-target="#id-settings" aria-expanded="true" aria-controls="id-settings">
                {{ __('people.id.properties') }}
            </button>
        </h2>
        <div id="id-settings" class="accordion-collapse collapse @if(!$selectedElement) show @endif" data-bs-parent="#id-elements-container">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    ...
                    <div class="mb-2">
                        <label for="background-color-opacity" class="form-label">{{ __('people.id.background-color-opacity') }}</label>
                        <input
                            type="range"
                            class="form-range"
    ...
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#selected-settings" aria-expanded="true" aria-controls="selected-settings">
                {{ $selectedElement::getName() }}
            </button>
        </h2>
        <div id="selected-settings" class="accordion-collapse collapse show" data-bs-parent="#id-elements-container">
