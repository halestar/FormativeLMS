    ...
    <div class="ms-2 mb-3" x-show="underline_selected">
        ...
        <div class="input-group mb-1">
            ...
            >
                ...
                <option value="dashed" @selected($element->getConfig('border-style', 'solid') == "dashed")>Dashed</option>
                <option value="dotted" @selected($element->getConfig('border-style', 'solid') == "dotted")>Dotted</option>
                <option value="double" @selected($element->getConfig('border-style', 'solid') == "double")>Double</option>
                <option value="groove" @selected($element->getConfig('border-style', 'solid') == "groove")>Groove</option>
                ...
                <option value="outset" @selected($element->getConfig('border-style', 'solid') == "outset")>Outset</option>
            </select>
        </div>
    </div>
</li>
