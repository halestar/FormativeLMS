            ...
            <div class="col-md-4">
                ...
                @else
                    <div class="mb-3">
                        ...
                        <input type="text" name="fieldPlaceholder" id="fieldPlaceholder" wire:model="fieldPlaceholder"
                               class="form-control" wire:change="updatePreview()"/>
                    </div>
                @endif
                <div class="d-grid gap-2">
                    <button type="button" class="btn btn-primary col "
                            wire:click="addField()">{{ __('people.roles.field.add') }}</button>
                </div>
            </div>
            <div class="col-md-4">
                            ...
                            <li class="list-group-item" wire:key="{{ $field->fieldName }}">
                                ...
                                <div class="input-group mb-3">
                                    <label for="copy_id_{{ $loop->iteration }}"
                                           class="input-group-text">{{ trans_choice('people.roles.field.copy', 1) }}</label>
