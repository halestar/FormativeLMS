<div>
    ...
    comprise of {{ $max_points }}
    max points and will range from 0 points, where student show no learning, to {{ $max_points - 1 }} points, where
    student show maximum learning. The rubric
    will have at least one criteria to assess the skill, with at most {{ $max_criteria }} criteria, make an educated
    ...
    assess anywhere from 1 to
    {{ $max_skills_per_criteria }} skills. For each criteria, you will then provide a description of how to assess that
