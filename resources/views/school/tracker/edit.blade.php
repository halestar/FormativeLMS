...
<div class="container">
    <h3 class="border-bottom mb-3 d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-primary" type="button" onclick="$('#assign-student-container').removeClass('d-none')">
    ...
    <form action="{{ route('subjects.student-tracker.update', $studentTracker) }}" method="POST">
        ...
        <div class="alert alert-dark d-none" id="assign-student-container">
            <label for="person-selector-search" class="form-label">{{{ __('school.student.tracking.select.student') }}}</label>
            ...
            <div class="text-end mt-2">
                ...
                <button type="button" class="btn btn-secondary" onclick="$('#assign-student-container').addClass('d-none')">Cancel</button>
            </div>
        </div>
    </form>
