...
@section('content')
    <div class="container">
        <form action="{{ route('subjects.skills.update.knowledge', $skill) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row mb-3">
                <div class="col-6">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="5">{{ $skill->description }}</textarea>
            ...
            <div class="row">
                <button type="submit" class="btn btn-primary col mx-2">{{ __('subjects.skills.knowledge.update') }}</button>
                <a href="{{ route('subjects.skills.show.knowledge', $skill) }}" class="btn btn-secondary col mx-2">{{ __('common.cancel') }}</a>
            </div>
        </form>
    </div>
@endsection
