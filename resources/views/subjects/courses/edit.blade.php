            ...
            <div class="row row-cols-4 mb-5">
                ...
                <div class="col align-self-start">
                    <div class="form-check mb-2">
                        ...
                        />
                        <label class="form-check-label" for="on_transcript">{{ __('subjects.course.on_transcript') }}</label>
                    </div>
                    <div class="form-check">
                        ...
                        />
                        <label class="form-check-label" for="gb_required">{{ __('subjects.course.gb_required') }}</label>
                    </div>
                </div>
                <div class="col align-self-start">
                    <div class="form-check mb-2">
                ...
                <div class="col align-self-start">
                    <div class="form-check mb-2">
                        ...
                        />
                        <label class="form-check-label" for="can_assign_honors">{{ __('subjects.course.can_assign_honors') }}</label>
                    </div>
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="active" name="active" @if($course->active) checked @endif value="1">
                        <label class="form-check-label" for="active">{{ __('subjects.subject.active') }}</label>
                    </div>
                </div>
            </div>
            <div class="row">
                <button class="btn btn-primary col mx-2" type="submit">{{ trans_choice('subjects.course.update', 1) }}</button>
                <a class="btn btn-secondary col mx-2" role="button" href="{{ route('subjects.courses.index', ['subject' => $course->subject_id]) }}">{{ __('common.cancel') }}</a>
            </div>
        </form>
    </div>
@endsection
