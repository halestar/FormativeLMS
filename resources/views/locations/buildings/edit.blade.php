        ...
        <div class="row profile-head-row">
            <div class="col-md-4">
                <div class="profile-img">
                    ...
                    />
                    <form action="{{ route('locations.buildings.update.img', ['building' => $building->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="tab-content profile-tab" id="profile-tab-content">
                    ...
                    >
                        <form action="{{ route('locations.buildings.update.areas', ['building' => $building->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            @error('areas')
