        ...
        <div class="row profile-head-row">
            ...
            <div class="col-md-6">
                <div class="profile-head d-flex align-items-start flex-column h-100">
                    <form id="basic-info-form" action="{{ route('locations.rooms.update.basic', $room) }}" method="POST" class="w-100">
                        @csrf
                        @method('PUT')
                        <h5 class="w-100">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="profile-work">
                    <form id="basic-info-form" action="{{ route('locations.rooms.update.campuses', $room) }}" method="POST" class="w-100">
                        @csrf
                        @method('PUT')
