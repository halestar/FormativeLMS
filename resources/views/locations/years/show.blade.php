...
@section('content')
    <div class="container">
        ...
        <div class="card mb-2 text-bg-light @if(!$errors->hasAny(['campus_id','term_label','term_start','term_end'])) d-none @endif" id="add-container">
        ...
        <div class="card mb-2 text-bg-light @if(!$errors->hasAny(['label','year_start','year_end'])) d-none @endif" id="edit-container">
