...
@section('content')
    <div class="container">
        ...
        <form method="POST" action="{{ route('locations.blocks.update', $block) }}">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-2 align-self-center">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="active" name="active" @if($block->active) checked @endif value="1">
            ...
            @enderror
            <div class="row">
                <button class="btn btn-primary col mx-2" type="submit">{{ trans_choice('locations.block.update', 1) }}</button>
                <button
                ...
                <a class="btn btn-secondary col mx-2" role="button" href="{{ route('locations.campuses.show', ['campus' => $block->campus_id]) }}">{{ __('common.cancel') }}</a>
            </div>
        </form>
    </div>
@endsection
