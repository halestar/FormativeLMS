...
class SkillSeeder extends Seeder
{
	...
	{
		//English
		$this->importSkills(database_path('data/standards/english.csv'), $this->subjects('English'));
		//Math
		$this->importSkills(database_path('data/standards/math.csv'), $this->subjects('Math'));
		//Science
		$this->importSkills(database_path('data/standards/science.csv'), $this->subjects('Science'));
		//Social Studies
		$this->importSkills(database_path('data/standards/social_science.csv'), $this->subjects('Social Studies'));
		//Art
		$this->importSkills(database_path('data/standards/art.csv'), $this->subjects('Art'));
		//Health
		$this->importSkills(database_path('data/standards/health.csv'), $this->subjects('Health'));
		//Languages
		$this->importSkills(database_path('data/standards/language.csv'), $this->subjects('Languages'));
