...
class BuildingSeeder extends Seeder
{
	public function blueprints(): array
	{
		return
			[
				[
					'blueprint_url' => asset('/images/floorplans/a-floor-1.png'),
					'rooms'         =>
						[
				...
				[
					'blueprint_url' => asset('/images/floorplans/a-floor-2.png'),
					'rooms'         =>
						[
				...
				[
					'blueprint_url' => asset('/images/floorplans/b-floor-1.png'),
					'rooms'         =>
						[
				...
				[
					'blueprint_url' => asset('/images/floorplans/b-floor-2.png'),
					'rooms'         =>
						[
				...
				[
					'blueprint_url' => asset('/images/floorplans/b-floor-3.png'),
					'rooms'         =>
						[
	...
	public function run(): void
	{
		...
		for ($i = 0; $i < 2; $i++)
		{
			...
			foreach ($this->blueprints()[$i]['rooms'] as $roomName => $room)
			{
				Room::create(
					[
						'name'     => is_numeric($roomName) ? fake()->numberBetween(
							($i + 1) * 100,
							($i + 1) * 100 + 99
						) : $roomName,
