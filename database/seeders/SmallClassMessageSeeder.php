...
class SmallClassMessageSeeder extends Seeder
{
	/**
	...
	public function run(): void
	{
		                    ...
		                    ->get() as $session)
		{
			...
			{
				//now we will create 0-5 random student messages
				...
				ClassMessage::factory()
				            ...
				            ->withSession($session)
				            ->withStudent($student)
				            ->withPostedBy($student->person->parents()
				                                           ->first())
				            ->fromParent()
				            ->create();
			}
