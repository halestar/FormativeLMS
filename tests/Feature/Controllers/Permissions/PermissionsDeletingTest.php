...
class PermissionsDeletingTest extends TestCase
{
	...
	{
		return route('settings.permissions.destroy', $id);
	}
	...
	public function test_delete_admin(): void
	{
		...
		$this->assertDatabaseMissing('permissions', ['id' => $this->id()]);
	}
	...
	public function test_delete_staff(): void
	{
		...
		$this->assertDatabaseHas('permissions', ['id' => $this->id()]);
	}
