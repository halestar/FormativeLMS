...
class PersonalPreferencesController extends Controller
{
	...
	public function communications(SchoolSettings $schoolSettings)
	{
		$person = auth()->user();
		$breadcrumb =
			[
	...
	public function communicationsDeliveryUpdate(Request $request)
	{
		$person = auth()->user();
	...
	public function communicationsSubscriptionsUpdate(Request $request)
	{
		$person = auth()->user();
