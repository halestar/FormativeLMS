...
class ClassMessages extends Component
{
    ...
    public function setYear(ClassMessage $classMessage = null)
    {
        ...
        $this->selectedYear = $this->years->where('id', $this->selectedYearId)->first();
    ...
    public function setStudent(ClassMessage $classMessage = null)
    {
        ...
        $this->selectedStudent = $this->students->where('id', $this->selectedStudentId)->first();
    ...
    public function setTerm(ClassMessage $classMessage = null)
    {
        ...
        $this->selectedTerm = $this->terms->where('id', $this->selectedTermId)->first();
        if($this->viewAs == 'faculty')
        {
            $this->sessions = $this->self->classesTaught()->where('term_id', $this->selectedTerm->id)->get();
            if($classMessage)
        ...
        elseif($this->viewAs == "student" || $this->viewAs == "parent")
        {
            ...
            elseif($this->viewAs == "student")
                ...
                $this->dispatch('change-student-term', studentId: $this->selectedStudentId, termId: $this->selectedTermId);
        }
    }
