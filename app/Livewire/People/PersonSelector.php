...
class PersonSelector extends Component
{
	...
	public function mount(?string $selectedCB = null, ?string $clearedCB = null, $filterRoles = null,
		int $maxResults = 5, ?string $placeholder = null, ?string $containerClasses = null)
	{
	...
	{
		$this->selectedPerson = $this->people->where('id', $personId)
		                                     ->first();
