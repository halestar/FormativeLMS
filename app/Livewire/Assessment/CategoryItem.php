...
class CategoryItem extends Component
{
    ...
    public function updateName()
    {
        ...
        $this->category->save();
        $this->dispatch('edit-category', editCategoryId: null)->to(SkillCategoryBrowser::class);
    }
    ...
    public function removeCategory()
    {
        if($this->category->canDelete())
        {
            ...
            if($this->selected)
            {
                ...
                $this->dispatch('select-category', selectedCategoryId: null)->to(SkillCategoryBrowser::class);
            }
        }
    }
