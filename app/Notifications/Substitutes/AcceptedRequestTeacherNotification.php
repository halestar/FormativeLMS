...
class AcceptedRequestTeacherNotification extends LmsNotification
{
    /**
	...
	{
		return new AcceptedRequestTeacherNotification(SubstituteRequest::inRandomOrder()->first(), Substitute::inRandomOrder()->first());
	}
