...
class AuthSettings extends SystemSetting
{
	...
	public function mfaForce(): Attribute
	{
		return $this->basicProperty('mfa_force');
	}

	public function mfaForceAdmins(): Attribute
	{
		return $this->basicProperty('mfa_force_admins');
	}

	public function mfaTimeoutDays(): Attribute
	{
		return $this->basicProperty('mfa_timeout_days');
	}
	...
	{
		return array_merge(parent::casts(), ['priorities' => AuthPriorities::class]);
	}
